...
// Database
import Database_Mrtproject_db from "./Database_Mrtproject_db.js";

// Controllers
import UserController from "../controllers/Mrtproject_db/UserController";
import KaryawanController from "../controllers/Mrtproject_db/KaryawanController";
import ScheduleController from "../controllers/Mrtproject_db/ScheduleController";
import ShiftController from "../controllers/Mrtproject_db/ShiftController";
...
class Server {
 ...
 // End Init Database
    ...
    // Start Init Controllers
		...
		KaryawanController.init(router);
		ScheduleController.init(router);
		ShiftController.init(router);
